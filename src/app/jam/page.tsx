...
export default function JamPage() {
  return (
    <div className="flex min-h-dvh flex-col">
      <TopNav />
      <main className="mx-auto flex w-full max-w-lg flex-1 flex-col justify-center px-6 py-10 safe-bottom">
        <header>
          <h1 className="text-3xl font-bold tracking-tight">Jam together</h1>
          <p className="mt-2 text-text-muted">
            Upload a song. Everyone plays their part, in sync.
          </p>
        </header>
